...
extension Network {
    struct Jira {
        ...
        private func fetchSprintFieldName() async throws -> String?  {
            ...
            let host = try await Files.Jira.Host.Reader.read()
...
extension Network.Jira {
    struct Request {
        ...
        func asURLRequest() async throws -> URLRequest {
            ...
            let credentials = try await Files.Jira.Credentials.Reader.read()
...
actor FieldsConfigurationProviding: DecodingConfigurationProviding {
